...
export default function CadastroEstoque() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit} style={{ background: '#F0F4F9', padding: '20px', borderRadius: '8px', marginBottom: '30px' }}>        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '15px' }}>
          ...
          <div>
            ...
            <input type="text" name="descricao" value={formData.descricao} className="soleitura" style={inputStyle} readOnly/>
          </div>
